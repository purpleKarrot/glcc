...
typedef boost::la::mat<GLfloat, 2, 2> mat2;

//! a 3x3 floating-point matrix
typedef boost::la::mat<GLfloat, 3, 3> mat3;

//! a 4x4 floating-point matrix
typedef boost::la::mat<GLfloat, 4, 4> mat4;

//! same as a mat2
typedef mat2 mat2x2;

//! a floating-point matrix with 2 columns and 3 rows
typedef boost::la::mat<GLfloat, 2, 3> mat2x3;

//! a floating-point matrix with 2 columns and 4 rows
typedef boost::la::mat<GLfloat, 2, 4> mat2x4;

//! a floating-point matrix with 3 columns and 2 rows
typedef boost::la::mat<GLfloat, 3, 2> mat3x2;

//! same as a mat3
typedef mat3 mat3x3;

//! a floating-point matrix with 3 columns and 4 rows
typedef boost::la::mat<GLfloat, 3, 4> mat3x4;

//! a floating-point matrix with 4 columns and 2 rows
typedef boost::la::mat<GLfloat, 4, 2> mat4x2;

//! a floating-point matrix with 4 columns and 3 rows
typedef boost::la::mat<GLfloat, 4, 3> mat4x3;
